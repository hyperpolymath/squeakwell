...
# Threat Model: Octad-Recover (working title — see naming section below)

## Document Info

| Field         | Value                          |
|---------------|--------------------------------|
| Project       | Octad-Recover (working title — see naming section below)               |
| Version       | 1.0                            |
...
Brief description of Octad-Recover (working title — see naming section below) and its architecture.
