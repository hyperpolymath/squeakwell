# squeakwell — Project Instructions

## Overview

Database recovery through cross-modal constraint propagation

**Status:** concept
**Priority in -iser family:** 4
**Part of:** https://github.com/hyperpolymath/iseriser (-iser ecosystem)

## Architecture

All -iser projects follow the same architecture:
- **Manifest** (`squeakwell.toml`) — user describes WHAT they want
