...
|*Source modules* |12 |Rust (main, lib, manifest/mod, engine/mod,
ingest/mod, abi/mod) + Idris2 ABI (3) + Zig FFI (3)
...
* [ ] *Error handling*: No tests for malformed audio input, codec
failures
