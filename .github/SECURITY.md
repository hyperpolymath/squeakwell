...
Replace all {{PLACEHOLDER}} values with your information:
  Octad-Recover (working title — see naming section below)     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  squeakwell             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/squeakwell/security/advisories/new)
...
- This repository (`hyperpolymath/squeakwell`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/squeakwell/security/advisories)
...
When using Octad-Recover (working title — see naming section below), we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/squeakwell/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/squeakwell/security/advisories/new) or {{SECURITY_EMAIL}} |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/squeakwell/discussions) |
...
*Thank you for helping keep Octad-Recover (working title — see naming section below) and its users safe.* 🛡️
