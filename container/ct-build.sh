...
#
# Octad-Recover (working title — see naming section below) — Cerro Torre build, sign, and verify pipeline
#
...
echo "=== Octad-Recover (working title — see naming section below) Cerro Torre Build Pipeline ==="
