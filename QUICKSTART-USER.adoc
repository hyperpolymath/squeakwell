...
// Replace squeakwell, Squeakwell — See README.adoc for details., just run, Squeakwell started successfully. with actuals
= squeakwell — Quick Start for Users
:toc:
:toclevels: 2

== What is squeakwell?

Squeakwell — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./squeakwell-portable
----
...
[source]
----
Squeakwell started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/squeakwell/wiki
