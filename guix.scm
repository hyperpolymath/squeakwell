...
;;
;; Guix package definition for Octad-Recover (working title — see naming section below)
;;
;; Usage:
;;   guix shell -D -f guix.scm    # Enter development shell
;;   guix build -f guix.scm       # Build package
;;
;; TODO: Replace Octad-Recover (working title — see naming section below) and customize inputs for your language/stack.
...
(package
  (name "Octad-Recover (working title — see naming section below)")
  (version "0.1.0")
  ...
  (home-page "https://github.com/hyperpolymath/Octad-Recover (working title — see naming section below)")
